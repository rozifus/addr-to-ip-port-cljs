...
{:shared {:clean-targets ["out" :target-path]
          ...
          :cljsbuild
          {:builds {:addr-to-ip-port-cljs
                    {:source-paths ["test/cljs"]
                     :compiler
                     {:output-dir "dev-resources/public/js"
                      :source-map "dev-resources/public/js/addr_to_ip_port_cljs.js.map"}}}
           :test-commands {"phantomjs"
                           ["phantomjs" :runner "dev-resources/public/js/addr_to_ip_port_cljs.js"]}}}
 :dev [:shared
